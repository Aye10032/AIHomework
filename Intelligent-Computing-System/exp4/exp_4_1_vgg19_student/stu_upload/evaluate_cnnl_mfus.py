...
def vgg19():
    ...
    for i, layer_name in enumerate(layers):
        if layer_name.startswith('conv'):
            # TODO: 在时序容器中传入卷积运算
            layer_container.add_module(layer_name, nn.Conv2d(in_channels, cfgs[i], 3, 1, 1))
            in_channels = cfgs[i]
            ...
            layer_container.add_module(layer_name, nn.MaxPool2d(2, 2))
...
if __name__ == '__main__':
    ...
    st = time.time()
    # TODO: 进行推理，得到prob
    # print(input_image.device, input_image.dtype)
