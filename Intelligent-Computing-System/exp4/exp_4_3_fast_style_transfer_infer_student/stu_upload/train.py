...
if __name__ == '__main__':
    ...
    while j <= epochs:
        for i, image in enumerate(data_loader):
            ...
            loss_ls1 = loss_func(get_gram_matrix(out1), get_gram_matrix(s1))
            loss_ls2 = loss_func(get_gram_matrix(out2), get_gram_matrix(s2))
            loss_ls3 = loss_func(get_gram_matrix(out3), get_gram_matrix(s3))
            loss_ls4 = loss_func(get_gram_matrix(out4), get_gram_matrix(s4))
