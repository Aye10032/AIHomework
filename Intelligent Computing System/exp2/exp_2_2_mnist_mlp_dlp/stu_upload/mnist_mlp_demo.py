...
class MNIST_MLP(object):
    ...
    def build_model(self, batch_size=100, input_size=784,
        ...
        # createMlpLayer(layer_name:str, input_shape:list, weight_shape:list, output_shape:list)
        ...
        # softmax
        output_shapem4 = pycnnl.IntVector(3)
        output_shapem4[0] = batch_size
        output_shapem4[1] = 1
        output_shapem4[2] = out_classes
        self.net.createSoftmaxLayer('sf', output_shapem4, axis=1)
