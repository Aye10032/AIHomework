...
class VGG19(object):
    ...
    def build_model(self, param_path='../../imagenet-vgg-verydeep-19.mat'):
        ...
        # pool3
        self.net.createPoolingLayer('pool3', input_shape34, 2, 2)
        ...
        # pool4
        self.net.createPoolingLayer('pool4', input_shape44, 2, 2)
        ...
        # pool5
        self.net.createPoolingLayer('pool5', input_shape54, 2, 2)
